...
- (по клику на кнопку меняй булево значение которое отслеживается  юзеффектом в котором запускается сетинтервал, по повторному клику изменяй булево на фолз и очищай интервал)
